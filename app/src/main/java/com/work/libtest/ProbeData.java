...
//    //shot format 6
//    public ProbeData(int survey_num, String company_name, String operator_name, String probe_ID, int hole_ID, int measurement_number, String _depth, String _date, int _shotFormat, int _recordNumber, double _roll, double _dip, double _azimuth, double _orientation_temp, double _acc_x, double _acc_y,
//                     double _acc_z, double _mag_x, double _mag_y, double _mag_z, boolean _show_mean_values,
...
//    }
    ...
    public String returnData() {
        ...
        if (shotFormat == 1) {
            ...
            returnString = surveyNum + "," + date + "," + time + "," + companyName + "," + operatorName + "," +probeID + "," + holeID + "," +measurementNumber + "," + depth + "," + Integer.toString(shotFormat) + "," +recordNumber + "," +roll + "," +dip + "," + azimuth + "," + orientation_temp +
    ...
    public String returnTitles() {
        ...
        if (shotFormat == 1) {
            ...
            returnString = "Survey Num,Date,Time,Company Name,Operator Name,Probe ID,Hole ID,Measurement Number,Depth,Shot Format,Record Number,Roll,Dip,Azimuth,Orientation Temp,Acc X,Acc Y,Acc Z,Acc Temp,Acc Mag Error,Mag X,Mag Y,Mag Z,Mag Temp,Show Mean Values,Max Mean AccX,Max Mean AccY,Max Mean AccZ,Max Mean MagX,Max Mean MagY,Max Mean MagZ,Fast Mag Only";
        } else if (shotFormat == 4) {
