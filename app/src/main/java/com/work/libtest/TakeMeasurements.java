...
//                    int numOfAdded = cumulativeList.size();
//
...
//                        Log.e(TAG, "Getting shot for: " + shotToCollect);
//                        boolean writeSuccess = bleService.setShotRequest(shotToCollect);
//
//
////                        boolean remove = false;
////                        if (!writeSuccess) {
////                            Log.e(TAG, "Sending a shot request returned incorrect");
////                            for (int i = 0; i < numOfAdded; i++) {
////                                shotsToCollect.remove();
////                            }
////                            remove = true;
////                        } else {
...
////                            if (!setProbeSuccess) {
////                                Log.e(TAG, "Sending probe idle false");
////                                if (!remove) {
////                                    for (int i = 0; i < numOfAdded; i++) {
////                                        shotsToCollect.remove();
////                                    }
...
//                }
//            } else {
//                Log.e(TAG, "error cannot withdraw whilst collecting data");
//            }
//        } catch (Exception e) {
...
//        //when this button is first pressed we want to turn the probe "on"
//        //COMEBACK
//        Log.i(TAG, "PJH - processing Live Data button press");
//        try {
//            if (!probeCollectingData) {
...
//            }
//        } catch (Exception e) {
//            Log.e(TAG, "Exception thrown in measurement click: " + e);
//        }
//    }
//
